...
type RuntimeCapabilityUsage = typeof RuntimeCapabilityUsage.Type;
...
declare function unwrapRuntimeErrorCause(error: unknown): unknown;
...
type RuntimeHostDispatchTaggedInput = {
  readonly kind: 'outbound_fetch';
  readonly outboundFetch: unknown;
  ...
  readonly kind: 'sand';
  readonly sand: unknown;
  readonly raw: unknown;
} | {
  readonly kind: 'namespace_tool';
  readonly namespace: string;
  readonly tool: string;
  readonly args: unknown;
  readonly raw: unknown;
} | {
  readonly kind: 'legacy_key';
  readonly key: string;
  readonly args: unknown;
  readonly raw: unknown;
} | {
...
declare const normalizeRuntimeHostDispatchInput: (input: unknown) => RuntimeHostDispatchTaggedInput;
interface RuntimeDispatchRouter {
  readonly dispatch: (input: unknown) => Effect.Effect<unknown, RuntimeError>;
}
declare const RuntimeDispatchRouter: Context.Service<RuntimeDispatchRouter, RuntimeDispatchRouter>;
...
declare const emptyRuntimePlan: (overrides?: Partial<RuntimePlan>) => RuntimePlan;
//#endregion
export { PreparedRuntimeProvider, PreparedRuntimeProviders, RuntimeArtifactRef, RuntimeArtifactWrite, RuntimeArtifacts, RuntimeCapabilityKind, RuntimeCapabilityProvider, RuntimeCapabilityUsage, RuntimeDispatchRouter, RuntimeError, RuntimeErrorReason, RuntimeExecutionMode, RuntimeExecutionRequest, RuntimeExecutionResult, RuntimeExecutor, RuntimeHost, RuntimeHostDispatchTaggedInput, RuntimeHostInvocation, RuntimeMetadata, RuntimeMountedInput, RuntimeNamespaceRequirement, RuntimePlan, RuntimePlanner, RuntimePlanningResult, RuntimeProviderPrepareInput, RuntimeProviderRegistry, RuntimeState, RuntimeStateEvent, TrustedExecutionContext, emptyRuntimePlan, normalizeRuntimeHostDispatchInput, unwrapRuntimeErrorCause };

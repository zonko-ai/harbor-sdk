...
//#endregion
//#region ../provider-overrides/src/index.d.ts
declare const ProviderOverrideDescriptor: Schema.Struct<{
  readonly id: Schema.String;
  readonly catalog_slugs: Schema.$Array<Schema.String>;
  readonly config_key: Schema.optional<Schema.String>;
  readonly auth_kind: Schema.optional<Schema.Literals<readonly ["none", "static_secret", "native_oauth", "global_confidential_oauth", "manual_client_oauth", "managed_account"]>>;
  readonly install_flow: Schema.optional<Schema.Literals<readonly ["direct", "discover", "discover_then_auth", "manual_credentials", "managed_provider", "queued_import"]>>;
  readonly adapters: Schema.$Record<Schema.String, Schema.String>;
  readonly runtime: Schema.optional<Schema.Struct<{
    readonly api_key_env: Schema.optional<Schema.String>;
    readonly callback_path: Schema.optional<Schema.String>;
    readonly client_id_env: Schema.optional<Schema.String>;
    readonly client_secret_env: Schema.optional<Schema.String>;
    readonly pending_code_verifier: Schema.optional<Schema.String>;
    readonly connected_account_session_key: Schema.optional<Schema.String>;
  }>>;
}>;
type ProviderOverrideDescriptor = typeof ProviderOverrideDescriptor.Type;
interface ComposioStaticAuthConfig {
  readonly auth_scheme: 'API_KEY' | 'BEARER_TOKEN' | 'BASIC';
  readonly credential_map: Readonly<Record<string, string>>;
  readonly validate_credentials?: boolean | undefined;
}
interface ManagedAccountSourceConfig {
  readonly auth_config_id: string;
  readonly descriptor: ProviderOverrideDescriptor;
  readonly static_auth?: ComposioStaticAuthConfig | undefined;
}
declare function managedAccountSourceConfig(config: Record<string, unknown>): ManagedAccountSourceConfig | undefined;
declare function managedAccountSourceConfigPatch(config: Record<string, unknown>): Record<string, string | ComposioStaticAuthConfig>;
declare function managedAccountDescriptor(): ProviderOverrideDescriptor | undefined;
declare function managedAccountConnectedAccountId(session: Record<string, unknown>): string | undefined;
declare function readManagedAccountSourceHandle(source: Record<string, unknown>): string | null;
...
interface OAuthAuthorizationUrlLike {
  readonly hostname: string;
  readonly searchParams: {
    set(name: string, value: string): void;
  };
}
declare function canonicalizeOAuthAuthorizationEndpoint(endpoint: string): string;
declare function canonicalizeMcpTransportEndpoint(endpoint: string): string;
declare function applyOAuthAuthorizationScopeParam(authUrl: OAuthAuthorizationUrlLike, scope: string): void;
declare function normalizeProviderOAuthTokens(parsed: Record<string, unknown>): NormalizedOAuthTokens | undefined;
declare function compileProviderAwareSourcePolicy(entry: CatalogEntry, context?: SourcePolicyContext): SourcePolicy;
declare function sourcePolicyAllowsGlobalClientActivation(entry: CatalogEntry): boolean;
//#endregion
export { ComposioStaticAuthConfig, ManagedAccountSourceConfig, ProviderOverrideDescriptor, type SourcePolicy, type SourcePolicyContext, applyOAuthAuthorizationScopeParam, canonicalizeMcpTransportEndpoint, canonicalizeOAuthAuthorizationEndpoint, compileProviderAwareSourcePolicy, managedAccountConnectedAccountId, managedAccountDescriptor, managedAccountSourceConfig, managedAccountSourceConfigPatch, normalizeProviderOAuthTokens, readManagedAccountSourceHandle, sourcePolicyAllowsGlobalClientActivation };
//# sourceMappingURL=provider-overrides.d.mts.map
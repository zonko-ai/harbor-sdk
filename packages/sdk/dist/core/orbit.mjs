...
const OrbitPrimitive = Schema.Literals([
	"kv",
	"blob",
	"log",
	"job",
...
const OrbitScope = Schema.Struct({
	workspace_id: WorkspaceId,
	run_id: Schema.optional(RunId)
});
const OrbitArtifactRef = Schema.Struct({
	workspace_id: WorkspaceId,
...
const OrbitStorageListBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	prefix: Schema.optional(Schema.String),
	limit: Schema.optional(Schema.Number),
	cursor: Schema.optional(Schema.String)
});
const OrbitStorageListResponse = Schema.Struct({
	objects: Schema.Array(OrbitStorageObject),
	truncated: Schema.Boolean,
	cursor: Schema.optional(Schema.String)
});
const OrbitStoragePutBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	key: OrbitStorageKey,
	data: Schema.Unknown,
	content_type: Schema.optional(Schema.String),
...
const OrbitStorageGetBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	key: OrbitStorageKey,
	encoding: Schema.optional(OrbitStorageEncoding)
});
const OrbitStorageGetResponse = Schema.NullOr(Schema.Struct({
...
const OrbitStorageUrlResponse = Schema.Struct({
	key: OrbitStorageKey,
	download_url: Schema.String,
	expires_at: Schema.String,
	expires_in_seconds: Schema.Number
});
const OrbitStorageDeleteBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	key: OrbitStorageKey
});
const OrbitStorageDeleteResponse = Schema.Struct({
...
const OrbitAiModelsResponse = Schema.Struct({
...
const OrbitAiTextOptions = Schema.Struct({
	model: Schema.optional(Schema.String),
	temperature: Schema.optional(Schema.Number),
	max_tokens: Schema.optional(Schema.Number)
});
const OrbitAiRunArgs = Schema.Struct({
	model: Schema.optional(Schema.String),
	input: Schema.Unknown,
	temperature: Schema.optional(Schema.Number),
	max_tokens: Schema.optional(Schema.Number)
});
const OrbitAiTextResponse = Schema.Struct({
	model: Schema.String,
	text: Schema.String,
	raw: Schema.Unknown
});
const OrbitAiSummaryResponse = Schema.Struct({
	model: Schema.String,
	summary: Schema.String,
	raw: Schema.Unknown
});
const OrbitAiEmbedResponse = Schema.Struct({
	model: Schema.String,
	embeddings: Schema.Array(Schema.Array(Schema.Number)),
	raw: Schema.Unknown
});
const OrbitAiClassifyResponse = Schema.Struct({
	model: Schema.String,
	label: Schema.String,
	raw: Schema.Unknown
});
const OrbitAiRerankResponse = Schema.Struct({
	model: Schema.String,
	ranking: Schema.Unknown,
	raw: Schema.Unknown
});
const OrbitUsageQueryBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
...
const OrbitUsageQueryResponse = Schema.Struct({
...
const OrbitJobListBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	limit: Schema.optional(Schema.Number),
	offset: Schema.optional(Schema.Number)
});
const OrbitJobListResponse = Schema.Struct({
	jobs: Schema.Array(OrbitJobSummary),
	count: Schema.Number
});
const OrbitJobInspectBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	name: OrbitJobName,
	version: Schema.optional(OrbitJobVersion)
});
const OrbitJobInspectResponse = Schema.Struct({ job: OrbitJobDetail });
const OrbitJobPublishBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	name: OrbitJobName,
	description: Schema.optional(Schema.String),
	kind: Schema.optional(OrbitJobKind),
...
const OrbitJobPublishResponse = Schema.Struct({
	job: Schema.Struct({
		name: OrbitJobName,
		version: OrbitJobVersion,
		status: OrbitJobVersionStatus,
...
const OrbitJobRunBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	name: OrbitJobName,
	version: Schema.optional(OrbitJobVersion),
...
const OrbitJobRunResponse = Schema.Struct({
	ok: Schema.Boolean,
	job: OrbitJobName,
	version: OrbitJobVersion,
...
const OrbitJobVersionsBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	name: OrbitJobName
});
const OrbitJobVersionsResponse = Schema.Struct({
	name: OrbitJobName,
	versions: Schema.Array(OrbitJobVersionRecord)
});
const OrbitJobDisableBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	name: OrbitJobName,
	version: Schema.optional(OrbitJobVersion)
});
const OrbitJobDisableResponse = Schema.Struct({
	name: OrbitJobName,
...
const OrbitJobInvocationListBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
...
const OrbitJobInvocationListResponse = Schema.Struct({
	invocations: Schema.Array(OrbitJobInvocationSummary),
	next_cursor: Schema.NullOr(Schema.String)
});
const OrbitJobInvocationGetBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	invocation_id: Schema.NonEmptyString
});
const OrbitJobInvocationGetResponse = Schema.Struct({ invocation: OrbitJobInvocationDetail });
const defineOrbitJob = (definition) => definition;
...
const OrbitSocketUrlBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
...
const OrbitSocketUrlResponse = Schema.Struct({
	channel: OrbitSocketChannel,
	url: Schema.String,
	expires_at: Schema.String
});
const OrbitSocketBroadcastBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	channel: OrbitSocketChannel,
	event: Schema.Unknown
});
const OrbitSocketBroadcastResponse = Schema.Struct({
	channel: OrbitSocketChannel,
	delivered: Schema.Number
});
const OrbitSocketStatsBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	channel: OrbitSocketChannel
});
const OrbitSocketStatsResponse = Schema.Struct({
	channel: OrbitSocketChannel,
...
const OrbitDbTablesBody = Schema.Struct({ workspace_id: OrbitWorkspaceId });
const OrbitDbTablesResponse = Schema.Struct({
...
const OrbitDbPeekBody = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
	table: OrbitDbTableName,
	limit: Schema.optional(Schema.Number),
	offset: Schema.optional(Schema.Number)
});
const OrbitDbPeekResponse = Schema.Struct({
	table: OrbitDbTableName,
...
const OrbitReadinessCheckKind = Schema.Union([
...
const OrbitReadinessSummary = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
...
const WorkspaceBranding = Schema.Struct({
	workspace_id: OrbitWorkspaceId,
...
const HOST_CALL_PRIMITIVE_KEYS = ORBIT_PRIMITIVE_KEYS.filter((key) => !WFP_NATIVE_PRIMITIVE_KEYS.includes(key));
function orbitAppListRow(app) {
	return {
		name: app.name,
		status: app.status,
...
function orbitAppDetailView(app) {
	return {
		name: app.name,
		status: app.status,
...
function orbitJobDetailView(job) {
	return {
		name: job.name,
		status: job.status,
...
function orbitJobVersionRow(version) {
	return {

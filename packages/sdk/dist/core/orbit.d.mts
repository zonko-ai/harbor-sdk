...
declare const OrbitStorageReadEncoding: Schema.Union<readonly [Schema.Literal<"bytes">, Schema.Literal<"text">, Schema.Literal<"base64">]>;
type OrbitStorageReadEncoding = typeof OrbitStorageReadEncoding.Type;
declare const OrbitStorageReadBody: Schema.Struct<{
  readonly workspace_id: Schema.String;
  readonly key: Schema.NonEmptyString;
  readonly offset: Schema.optional<Schema.Number>;
  readonly length: Schema.optional<Schema.Number>;
  readonly encoding: Schema.optional<Schema.Union<readonly [Schema.Literal<"bytes">, Schema.Literal<"text">, Schema.Literal<"base64">]>>;
}>;
type OrbitStorageReadBody = typeof OrbitStorageReadBody.Type;
declare const OrbitStorageReadResponse: Schema.Struct<{
  readonly bytes: Schema.optional<Schema.Uint8Array>;
  readonly text: Schema.optional<Schema.String>;
  readonly data_base64: Schema.optional<Schema.String>;
  readonly size: Schema.Number;
...
type OrbitStorageReadResponse = typeof OrbitStorageReadResponse.Type;
...
declare const HOST_CALL_PRIMITIVE_KEYS: ("storage_put" | "storage_get" | "storage_list" | "storage_delete" | "storage_url" | "storage_read" | "cache_get" | "cache_set" | "cache_delete" | "socket_url" | "socket_broadcast" | "socket_stats" | "tools_search" | "tools_describe" | "tools_namespaces" | "ai_run" | "ai_generate" | "ai_summarize" | "ai_embed" | "ai_classify" | "ai_rerank" | "ai_models")[];

...
interface HarborDeviceLoginOptions {
  readonly baseUrl: string;
  readonly fetch?: typeof fetch | undefined;
}
interface HarborDeviceLoginStart {
...
type HarborDeviceLoginPollResult = {
  ...
  readonly switchApiKey?: string | undefined;
};
interface HarborDeviceLoginPollOptions extends HarborDeviceLoginOptions {
  readonly deviceCode: string;
  readonly workspaceId?: string | undefined;
}
declare class HarborAuthError extends Error {
...
//#endregion
export { HarborAuthError, HarborDeviceLoginOptions, HarborDeviceLoginPollOptions, HarborDeviceLoginPollResult, HarborDeviceLoginStart, pollHarborDeviceLogin, startHarborDeviceLogin };
